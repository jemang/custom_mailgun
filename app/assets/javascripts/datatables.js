...
$.extend( $.fn.dataTable.ext.classes, {
  sFilterInput: "form-control dttb-search",
...
$.extend( $.fn.dataTable.defaults, {
  ...
  pagingType: 'full',
  dom:
   "<'row'<'col-sm-4 text-left'l> <'col-sm-4 text-left'f><'right-action col-sm-4 text-right'<'buttons'B> <'select-info'> p>>" +
   "<'row'<'dttb col-12 px-0'tr>>" +
   "<'row'<'col-sm-12 table-footer'i>>",
  language: {search: ""},
  preDrawCallback: function( setting ){
    $('.dttb-search').attr('placeholder', 'search');
  }
